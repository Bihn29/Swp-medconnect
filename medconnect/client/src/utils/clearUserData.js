  ...
  try {
    ...
    if ('indexedDB' in window) {
      try {
        ...
        deleteReq.onerror = () => console.log('Error clearing Firebase IndexedDB');
        
        // Clear other possible IndexedDB databases
        const deleteReq2 = indexedDB.deleteDatabase('firebase-auth-db');
        deleteReq2.onsuccess = () => console.log('Firebase Auth IndexedDB cleared');
        deleteReq2.onerror = () => console.log('Error clearing Firebase Auth IndexedDB');
      } catch (e) {
