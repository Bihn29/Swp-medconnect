...
const HomeVisit = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      price: '600.000đ',
      duration: '45 phút',
      description: 'Theo dõi tình trạng sức khỏe định kỳ cho bệnh nhân mãn tính',
  ...
  const benefits = [
    ...
    {
      icon: <ClockCircleOutlined style={{ fontSize: '48px', color: '#45c3d2' }} />,
  ...
  const handleBooking = (values) => {
    ...
    Modal.success({
      ...
      content: 'Chúng tôi sẽ liên hệ với bạn trong vòng 15 phút để xác nhận lịch hẹn.',
    });
  ...
  return (
    <div className="home-visit">
          ...
          <Row justify="center" align="middle" style={{ minHeight: '400px' }}>
            <Col xs={24} lg={16} style={{ textAlign: 'center' }}>
              ...
              <Paragraph style={{ 
                ...
                Dịch vụ y tế chuyên nghiệp đến tận nhà - An toàn, tiện lợi, chất lượng cao
              </Paragraph>
              ...
              <Col xs={24} sm={12} lg={6} key={service.id}>
                <Card
                  ...
                  style={{ 
                    ...
                    borderRadius: '12px',
                    cursor: 'pointer',
                    border: selectedService === service.id ? '2px solid #45c3d2' : '1px solid #f0f0f0'
                  }}
                >
                  ...
                  {selectedService === service.id && (
                    <div style={{ marginTop: '16px' }}>
                      <CheckCircleOutlined style={{ color: '#45c3d2', fontSize: '20px' }} />
                      <Text style={{ marginLeft: '8px', color: '#45c3d2', fontWeight: 600 }}>
                        Đã chọn
                      </Text>
                    </div>
                  )}
      ...
      {/* Doctors Section */}
      <section id="booking-section" style={{ padding: '80px 0', background: '#f8f9fa' }}>
        <div className="container">
          <Title level={2} style={{ textAlign: 'center', marginBottom: '60px' }}>
                  ...
                  <Card.Meta
                    ...
                    description={
                      <div>
                        ...
                        <div>
                          <Text strong style={{ color: '#45c3d2', fontSize: '16px' }}>
                            {doctor.price}
                          </Text>
                        </div>
                      </div>
      ...
      <Modal
        title={
          <div>
            <CalendarOutlined style={{ marginRight: '8px', color: '#45c3d2' }} />
