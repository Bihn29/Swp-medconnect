              ...
              <Card size="small" title="Thông tin người thân">
                <Space direction="vertical" size="small">
                  ...
                  <div>
                    <Text type="secondary">
                      Quan hệ:{" "}
                      {appointment.patientId.relationshipToOwner === "father"
                        ? "Bố"
                        : appointment.patientId.relationshipToOwner === "mother"
                        ? "Mẹ"
                        : appointment.patientId.relationshipToOwner === "spouse"
                        ? "Vợ/Chồng"
                        : appointment.patientId.relationshipToOwner === "child"
                        ? "Con"
                        : appointment.patientId.relationshipToOwner ===
                          "grandparent"
                        ? "Ông/Bà"
